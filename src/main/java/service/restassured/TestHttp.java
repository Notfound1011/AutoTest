...
public class TestHttp {
    ...
    void schema_wrong() {
        ...
        user.getUser("seveniruby").then().body(matchesJsonSchemaInClasspath("service/user/testcase/user_get_schema.json"));
    }
    ...
    void schema_right() {
        UserApi user = new UserApi();
        user.getUser("seveniruby").then().body(matchesJsonSchemaInClasspath("service/user/testcase/user_get_schema_right.json"));
    }
